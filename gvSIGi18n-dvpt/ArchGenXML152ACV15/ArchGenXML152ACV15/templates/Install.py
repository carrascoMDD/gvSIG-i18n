...
<dtml-let tool_instance_name="c.getTaggedValue('tool_instance_name', 'portal_'+ c.getName().lower() )"
    ...
    portal_controlpanel.unregisterConfiglet('<dtml-var "tool_instance_name">') # ACV 20090325 changed  we want the ID entered in the modeling tool was '<dtml-var "c.getName()">')
    portal_controlpanel.registerConfiglet(
        '<dtml-var "tool_instance_name">', # ACV 20090325 changed  we want the ID entered in the modeling tool  was '<dtml-var "c.getName()">', #id of your Tool
        ...
        1, # visibility
        '<dtml-var "package.getProductName ()">', # ACV changed we want the application name to be the product name entered in the modelling tool  was '<dtml-var "c.getName()">ID',
...
<dtml-in "configlet_tools">
# ACV 20090326 to use instance name configured in modeling tool
<dtml-let tool_instance_name="_['sequence-item'].getTaggedValue('tool_instance_name', 'portal_'+ _['sequence-item'].getName().lower() )">
        portal_control_panel.unregisterConfiglet('<dtml-var "tool_instance_name">')
</dtml-let>
</dtml-in>
</dtml-if>
</dtml-let>
