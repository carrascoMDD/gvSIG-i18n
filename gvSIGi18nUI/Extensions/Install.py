# -*- coding: utf-8 -*-
#
# File: Install.py in gvSIGi18nUI product
#
...
from Products.gvSIGi18nUI.config import PROJECTNAME
from Products.gvSIGi18nUI.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install gvSIGi18nUI """
    out = StringIO()
    ...
    try:
        from Products.gvSIGi18nUI.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.gvSIGi18nUI.config import STYLESHEETS
    try:
        ...
        pass
    from Products.gvSIGi18nUI.config import JAVASCRIPTS
    try:
