...
function resizePage() {
	...
	if (browser=="ie7") {
		document.getElementById('resizeFrames').style.height=top.document.body.clientHeight-72+'px';
		changeCSS('#tmpRF','height',top.document.body.clientHeight-72+'px','this');
	} else {
...
function setCSS() {
	if (browser=="ie6"||browser=="ie7") {
		...
		changeCSS('#resizeFrames','height',top.document.body.clientHeight-72+'px','this');
