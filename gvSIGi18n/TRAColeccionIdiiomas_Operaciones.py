# -*- coding: utf-8 -*-
#
# File: TRAColeccionIdiiomas_Operaciones.py
#
...
class TRAColeccionIdiiomas_Operaciones:
    """
    """
...
# ###############################                  
    ...
    def fCrearIdioma( self,
        ...
        """Create a new instance of TRAIdioma.
        ...
        try:
            ...
            try:
                ...
                if not unNewTypeName:
                    unNewTypeName = cNombreTipoTRAIdioma
                
                aNewCodigoIdiomaEnGvSIG       = theAdditionalParams.get( 'theNewCodigoIdiomaEnGvSIG', None)
                aCodigoInternacionalDeIdioma  = theAdditionalParams.get( 'theCodigoInternacionalDeIdioma',    None)
                aNewEnglishName               = theAdditionalParams.get( 'theNewEnglishName',    None)
                aNewNombreNativoDeIdioma      = theAdditionalParams.get( 'theNewNombreNativoDeIdioma',    None)
