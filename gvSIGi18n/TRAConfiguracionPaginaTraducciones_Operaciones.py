# -*- coding: utf-8 -*-
#
# File: TRAConfiguracionPaginaTraducciones_Operaciones.py
#
...
class TRAConfiguracionPaginaTraducciones_Operaciones:
    """
    """
...
# end of class TRAConfiguracionPaginaTraducciones_Operaciones
