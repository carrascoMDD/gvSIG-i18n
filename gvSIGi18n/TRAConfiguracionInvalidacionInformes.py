# -*- coding: utf-8 -*-
#
# File: TRAConfiguracionInvalidacionInformes.py
#
...
from TRAConfiguracionAlmacenPaginas_Operaciones import TRAConfiguracionInvalidacionInformes_Operaciones
...
schema = Schema((
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeIdiomas_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeIdiomas_help',
        ...
        position="5",
        owner_class_name="TRAConfiguracionInvalidacionInformes"
    ),
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeCambiosAnularInformeIdiomas_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeCambiosAnularInformeIdiomas_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Numero de cambios de estado de Traducciones que causan la anulacion del Informe de Estado por Idiomas, incluso aunque no haya expirado el plazo de retencion del informe.",
        duplicates="0",
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeModulosEIdiomas_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeModulosEIdiomas_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Tiempo en segundos que se retendra el Informe de Estado por Modulos e Idiomas, aunque sus resultados sean inexactos por alguna modificacion del estado de traducciones, para evitar recalculo excesivo por cambios poco relevantes.",
        duplicates="0",
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeCambiosAnularInformeModulosEIdiomas_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeCambiosAnularInformeModulosEIdiomas_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Numero de cambios de estado de Traducciones que causan la anulacion del Informe de Estado por Modulos e Idiomas, incluso aunque no haya expirado el plazo de retencion del informe.",
        duplicates="0",
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeActividadesAnularInformeActividad_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeActividadesAnularInformeActividad_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Numero de Actividades que causan la anulacion del Informe de Actividad, incluso aunque no haya expirado el plazo de retencion del informe.",
        duplicates="0",
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeActividad_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeActividad_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Tiempo en segundos que se retendra el Informe deActividad, aunque sus resultados sean inexactos por alguna modificacion del estado de traducciones, para evitar recalculo excesivo por cambios poco relevantes.",
        duplicates="0",
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            label="Cambios para Anular Informe de Contribuciones",
            label2="Changes to invalidate Contributions Report",
            description="Numero de cambios de estado de Traducciones que causan la anulacion del Informe de Usuarios Contribuidores, incluso aunque no haya expirado el plazo de retencion del informe.",
            description2="Number of Translation status changes that shall cause the invalidation of the User Contributions Report, even if the minimum retention time has not lapsed yet.",
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeCambiosAnularInformeContribuciones_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_numeroDeCambiosAnularInformeContribuciones_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Numero de cambios de estado de Traducciones que causan la anulacion del Informe de Usuarios Contribuidores, incluso aunque no haya expirado el plazo de retencion del informe.",
        duplicates="0",
        ...
        styleex="volatile=0;",
        description2="Number of Translation status changes that shall cause the invalidation of the User Contributions Report, even if the minimum retention time has not lapsed yet.",
        ea_guid="{DB3C1C85-D345-41a8-8DE6-E186F72775ED}",
        scale="0",
        default="100",
        label="Cambios para Anular Informe de Contribuciones",
        length="0",
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            description="Tiempo en segundos que se retendra el Informe de Estado por Modulos e Idiomas, aunque sus resultados sean inexactos por alguna modificacion del estado de traducciones, para evitar recalculo excesivo por cambios poco relevantes.",
            description2="Time in seconds that the Status Report by Modules and Languages shall be retained, even if the results have become inaccurate because of any modification of translations status. To avoid excessive recalculation for barely relevant changes.",
            label_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeContribuciones_label',
            description_msgid='gvSIGi18n_TRAConfiguracionInvalidacionInformes_attr_segundosMinimosRetencionInformeContribuciones_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Tiempo en segundos que se retendra el Informe de Estado por Modulos e Idiomas, aunque sus resultados sean inexactos por alguna modificacion del estado de traducciones, para evitar recalculo excesivo por cambios poco relevantes.",
        duplicates="0",
        ...
        styleex="volatile=0;",
        description2="Time in seconds that the Status Report by Modules and Languages shall be retained, even if the results have become inaccurate because of any modification of translations status. To avoid excessive recalculation for barely relevant changes.",
        ea_guid="{2D043C84-61DB-449b-8FEC-1AF877154FF5}",
        scale="0",
        default="1800",
        label="Minimo Tiempo en segundos que se retiene el Informe de Estado por Modulos e Idiomas",
        length="0",
...
TRAConfiguracionInvalidacionInformes_schema = OrderedBaseFolderSchema.copy() + \
    getattr(TRAConfiguracion, 'schema', Schema(())).copy() + \
    getattr(TRAConfiguracionInvalidacionInformes_Operaciones, 'schema', Schema(())).copy() + \
    schema.copy()

##code-section after-schema #fill in your manual code here
##/code-section after-schema

class TRAConfiguracionInvalidacionInformes(OrderedBaseFolder, TRAConfiguracion, TRAConfiguracionInvalidacionInformes_Operaciones):
    """
    """
    security = ClassSecurityInfo()
    __implements__ = (getattr(OrderedBaseFolder,'__implements__',()),) + (getattr(TRAConfiguracion,'__implements__',()),) + (getattr(TRAConfiguracionInvalidacionInformes_Operaciones,'__implements__',()),)

    # This name appears in the 'add' box
    archetype_name = 'Configuracion Invalidacion Informes'

    meta_type = 'TRAConfiguracionInvalidacionInformes'
    ...
    allowed_content_types = [] + list(getattr(TRAConfiguracion, 'allowed_content_types', [])) + list(getattr(TRAConfiguracionInvalidacionInformes_Operaciones, 'allowed_content_types', []))
    ...
    suppl_views                      = ['Tabular',]
    typeDescription                  = "Configuracion del catalogo de traducciones, con parametros controlando la invalidacion de informes generados del catalogo."
    typeDescMsgId                    =  'gvSIGi18n_TRAConfiguracionInvalidacionInformes_help'
    archetype_name2                  = 'Reports Invalidation Configuration'
    typeDescription2                 = '''Translations catalog configuration, with parameters controlling the invalidation of reports generated from the catalog.'''
    archetype_name_msgid             = 'gvSIGi18n_TRAConfiguracionInvalidacionInformes_label'
    ...
    schema = TRAConfiguracionInvalidacionInformes_schema
...
registerType(TRAConfiguracionInvalidacionInformes, PROJECTNAME)
# end of class TRAConfiguracionInvalidacionInformes
