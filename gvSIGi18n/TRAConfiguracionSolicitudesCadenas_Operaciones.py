# -*- coding: utf-8 -*-
#
# File: TRAConfiguracionSolicitudesCadenas_Operaciones.py
#
...
class TRAConfiguracionSolicitudesCadenas_Operaciones:
    """
    """
...
# end of class TRAConfiguracionSolicitudesCadenas_Operaciones
