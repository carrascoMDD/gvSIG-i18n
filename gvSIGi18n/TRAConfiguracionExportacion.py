...
schema = Schema((
    ...
    StringField(
        ...
        widget=SelectionWidget(
            label="Exportar fechas y usuarios contribuidores",
            label2="Export contributing dates and user names",
            description="Exportar para cada traduccion las fechas y nombres de usuario que la crearon, tradujeron, revisaron o marcaron como definitiva.",
            description2="Export for each translation the dates and user names that created, translated, reviewed or marked it as definitive.",
            label_msgid='gvSIGi18n_TRAConfiguracionExportacion_attr_exportarContribucionesPorDefecto_label',
            description_msgid='gvSIGi18n_TRAConfiguracionExportacion_attr_exportarContribucionesPorDefecto_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Exportar para cada traduccion las fechas y nombres de usuario que la crearon, tradujeron, revisaron o marcaron como definitiva.",
        vocabulary=['Si','No',],
        duplicates="0",
        vocabulary_msgids=['gvSIGi18n_TRAConfiguracionExportacion_attr_exportarContribucionesPorDefecto_option_Si', 'gvSIGi18n_TRAConfiguracionExportacion_attr_exportarContribucionesPorDefecto_option_No'],
        label2="Export contributing dates and user names",
        ea_localid="2058",
        derived="0",
        precision=0,
        ...
        styleex="volatile=0;",
        description2="Export for each translation the dates and user names that created, translated, reviewed or marked it as definitive.",
        ea_guid="{C8AA6AA2-51F5-401d-A400-603B9E73069D}",
        vocabulary2=['Yes','No',],
        scale="0",
        default="Si",
        label="Exportar fechas y usuarios contribuidores",
