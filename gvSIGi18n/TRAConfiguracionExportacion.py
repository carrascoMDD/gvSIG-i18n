...
schema = Schema((
    ...
    StringField(
        name='exportarTRAImportacionesPorDefecto',
        widget=SelectionWidget(
            label="Exportar las TRAImportacion en XML",
            label2="Export the TRAImportacion in XML",
            description="Exportar las importaciones en fichero XML.",
            description2="Export the imports in an XML file.",
            label_msgid='gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAImportacionesPorDefecto_label',
            description_msgid='gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAImportacionesPorDefecto_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Exportar las importaciones en fichero XML.",
        vocabulary=['Si','No',],
        duplicates="0",
        vocabulary_msgids=['gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAImportacionesPorDefecto_option_Si', 'gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAImportacionesPorDefecto_option_No'],
        label2="Export the TRAImportacion in XML",
        ea_localid="2015",
        derived="0",
        precision=0,
        ...
        styleex="volatile=0;",
        description2="Export the imports in an XML file.",
        ea_guid="{7AF395A4-D3E7-4577-8781-77A03C135B19}",
        vocabulary2=['Yes','No',],
        scale="0",
        default="No",
        label="Exportar las TRAImportacion en XML",
    ...
    StringField(
        name='exportarTRAProgresosPorDefecto',
        widget=SelectionWidget(
            label="Exportar los TRAProgreso en XML",
            label2="Export the TRAProgreso in XML",
            description="Exportar los progresos y resultados de procesos de larga duracion en fichero XML.",
            description2="Export the progresses and results of long-lived processes in an XML file.",
            label_msgid='gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAProgresosPorDefecto_label',
            description_msgid='gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAProgresosPorDefecto_help',
            i18n_domain='gvSIGi18n',
        ),
        description="Exportar los progresos y resultados de procesos de larga duracion en fichero XML.",
        vocabulary=['Si','No',],
        duplicates="0",
        vocabulary_msgids=['gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAProgresosPorDefecto_option_Si', 'gvSIGi18n_TRAConfiguracionExportacion_attr_exportarTRAProgresosPorDefecto_option_No'],
        label2="Export the TRAProgreso in XML",
        ea_localid="2016",
        derived="0",
        precision=0,
        ...
        styleex="volatile=0;",
        description2="Export the progresses and results of long-lived processes in an XML file.",
        ea_guid="{B8125CDA-343D-4198-BEA9-0357912C9D55}",
        vocabulary2=['Yes','No',],
        scale="0",
        default="No",
        label="Exportar los TRAProgreso en XML",
