# -*- coding: utf-8 -*-
#
# File: TRAElemento_Constants_Views.py
#
...
"""
cTRAPrivateCacheViewsForQualifiedUsers = [ 
    'TRACatalogo',                  'TRACatalogo_NoHeaderNoFooter', 
...
cTRADefaultPagesForTypes = dict( [ [ aTypeName, 'Tabular'] for aTypeName in cTodosNombresTipos])
cTRADefaultPagesForTypes.update( {
