...
cTRAExportedFilesDiskPath   = os.path.join( getConfiguration().clienthome, cTRAExportedFilesFolderName)
...
cPropertiesModulesLinePrefix = '#Modules '
...
#cGNUgettextPOEntryTemplateString_Modules            = """#: --modules-- %(Modules)s\n"""
