...
class TRAElemento_TraversalConfig:            
    ...
    {   'portal_types': [ 'TRAColeccionImportaciones', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'importaciones',
                'columns':              [ 'title', 'description', 'comenzarAlFinalizarAnterior', 'debeCrearTraduccionesQueFaltan', 'estadoProceso', 'haComenzado', 'haCompletadoConExito', 'fechaFinProceso', 'versionDelProducto', 'buildDelProducto', ],
                'contains_collections': False,
                'tabular_tree':         False,
                'subitems':             [
                    {   'portal_types': [ 'TRAImportacion', ],
    ...
    {   'portal_types': [ 'TRAImportacion', ],
        ...
        'traversals':   [
            ...
            {   'relation_name':      'informeEstadoAntes',
                'columns':            [ 'title', 'description', ],
                'exclude_from_views': [ 'Textual', 'General', ],
                'related_types':      [
                    {   'portal_types': [ 'TRAInforme', ],
            ...
            {   'relation_name':      'informeEstadoDespues',
                'columns':            [ 'title', 'description', ],
                'exclude_from_views': [ 'Textual', 'General', ],
                'related_types':      [
                    {   'portal_types': [ 'TRAInforme', ],
