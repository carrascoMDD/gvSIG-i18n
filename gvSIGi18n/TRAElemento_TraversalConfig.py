...
class TRAElemento_TraversalConfig:            
    ...
    {   'portal_types': [ 'TRACatalogo', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'configuraciones',
                ...
                'read_only':            True,
                'subitems':             [
                    {   'portal_types': [ 'TRAConfiguracionAlmacenPaginas', 'TRAConfiguracionExportacion', 'TRAConfiguracionImportacion', 'TRAConfiguracionPaginaTraducciones', 'TRAConfiguracionPerfilEjecucion', 'TRAConfiguracionPermisos', 'TRAConfiguracionSolicitudesCadenas', 'TRAConfiguracionVarios', ],
                        'reuse_config': 'Default',
                    },
                ],
            },
    ...
    {   'portal_types': [ 'TRAConfiguracionAlmacenPaginas', ],
        'config_name':  'Mention',
        'mode':         'Reference',
        'extension':    'OneParagraph',
        'attrs':        [
