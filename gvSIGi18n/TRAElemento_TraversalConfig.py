    ...
    {   'portal_types': [ 'TRACatalogo', ],
        ...
        'traversals':   [
            ...
            {   'relation_name': 'ultimoInforme',
                'columns':       [ 'title', 'description', 'esAutoActualizable', 'haCompletadoConExito', ],
                'related_types': [
    ...
    {   'portal_types': [ 'TRAColeccionIdiomas', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'idiomas',
                'columns':              [ 'title', 'description', 'codigoIdiomaEnGvSIG', 'codigoInternacionalDeIdioma', 'nombreNativoDeIdioma', ],
                'contains_collections': False,
                'tabular_tree':         False,
                'read_only':            True,
                'subitems':             [
    ...
    {   'portal_types': [ 'TRAColeccionSolicitudesCadenas', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'solicitudesCadenas',
                'columns':              [ 'title', 'description', 'simbolo', 'estadoSolicitudCadena', ],
                'contains_collections': False,
                'tabular_tree':         False,
