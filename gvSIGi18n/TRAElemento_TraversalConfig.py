...
class TRAElemento_TraversalConfig:            
    ...
    {   'portal_types': [ 'TRACatalogo', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'configuraciones',
                'columns':              [ 'title', 'description', 'aspectoConfiguracion', ],
                'contains_collections': False,
                'tabular_tree':         False,
                'read_only':            True,
                'subitems':             [
            ...
            {   'aggregation_name':     'parametrosControlProgreso',
                'columns':              [ 'title', 'description', 'tipoProceso', ],
                'contains_collections': False,
                'tabular_tree':         False,
                'read_only':            True,
                'subitems':             [
    ...
    {   'portal_types': [ 'TRAColeccionContribuciones', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'contribuciones',
                'columns':              [ 'title', 'description', 'fechaFinProceso', ],
                'contains_collections': False,
                'tabular_tree':         False,
    ...
    {   'portal_types': [ 'TRAColeccionIdiomas', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'idiomas',
                'columns':              [ 'title', 'description', 'codigoIdiomaEnGvSIG', 'estaBloqueado', 'codigoInternacionalDeIdioma', 'nombreNativoDeIdioma', ],
                'contains_collections': False,
                'tabular_tree':         False,
                'read_only':            True,
                'subitems':             [
    ...
    {   'portal_types': [ 'TRAColeccionImportaciones', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'importaciones',
                'columns':              [ 'title', 'description', 'identificadorElementoProgreso', ],
                'contains_collections': False,
                'tabular_tree':         False,
                'subitems':             [
    ...
    {   'portal_types': [ 'TRAColeccionInformes', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'informes',
                'columns':              [ 'title', 'description', 'haCompletadoConExito', ],
                'contains_collections': False,
                'tabular_tree':         False,
    ...
    {   'portal_types': [ 'TRAColeccionProgresos', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'progresos',
                'columns':              [ 'title', 'description', 'tipoProceso', 'estadoProceso', 'haComenzado', 'haCompletadoConExito', ],
                'contains_collections': False,
                'tabular_tree':         False,
    ...
    {   'portal_types': [ 'TRAColeccionSolicitudesCadenas', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'solicitudesCadenas',
                'columns':              [ 'title', 'description', 'simbolo', 'estadoSolicitudCadena', 'nombresModulos', ],
                'contains_collections': False,
                'tabular_tree':         False,
    ...
    {   'portal_types': [ 'TRAContribuciones', ],
        ...
        'traversals':   [
            {   'relation_name': 'elementoProgreso',
                'columns':       [ 'title', 'description', 'estadoProceso', 'haCompletadoConExito', ],
                'related_types': [
                    {   'portal_types': [ 'TRAProgreso', ],
                        'reuse_config': 'Default',
                    },
    ...
    {   'portal_types': [ 'TRAImportacion', ],
        ...
        'traversals':   [
            {   'aggregation_name':     'contenidos',
                'columns':              [ 'title', 'description', 'excluirDeImportacion', 'ficheroLeido', ],
                'contains_collections': False,
                'tabular_tree':         False,
    ...
    {   'portal_types': [ 'TRAProgreso', ],
        ...
        'traversals':   [
            {   'relation_name': 'elementoEspecificacionProceso',
                'columns':       [ 'title', 'description', 'estadoProceso', 'haCompletadoConExito', ],
                'related_types': [
                    {   'portal_types': [ 'TRAImportacion', ],
                        'reuse_config': 'Default',
