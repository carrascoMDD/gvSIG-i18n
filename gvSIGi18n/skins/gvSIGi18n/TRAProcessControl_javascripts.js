...
function pTRAAsyncRequest_Response_Display( theResponseText, theParameter) {
    ...
    if ( !( unSuccess == 'true')) {
        fTRA_SetBGColorEnCadenaTraducidaFilaNumero(   unIndexTraduccion, cTRABGColor_Process_Failed);
        if ( unChangeStatus == 'DifferentChangeCounter') { 
            ...
            fTRA_SetContenidoTextoElementoWithId( 'cid_TRAInteractionMessage', unChangeMessage);        
            pTRAShowElementWithId(  'cid_TRAInteractionMessageHolder');
...
function fEstado_BGcolor( theEstado ) {    
    ...
    if ( ! theEstado) {
        return cTRABGColor_Process_NotLaunched;
    }
    if ( theEstado == "NotLaunched") {
        return cTRABGColor_Process_NotLaunched;
    }
    if ( theEstado == "Launched") {
        return cTRABGColor_Process_Launched;
    }
    if ( theEstado == "Terminated") {
        return cTRABGColor_Process_Terminated;
    }
    return cTRABGColor_Process_NotLaunched;
}
...
function fEstado_FGcolor( theEstado ) {    
    ...
    if ( ! theEstado) {
        return cTRAFGColor_Process_NotLaunched;
    }
    if ( theEstado == "NotLaunched") {
        return cTRAFGColor_Process_NotLaunched;
    }
    if ( theEstado == "Launched") {
        return cTRAFGColor_Process_Launched;
    }
    if ( theEstado == "Terminated") {
        return cTRAFGColor_Process_Terminated;
    }
    return cTRAFGColor_Process_NotLaunched;
