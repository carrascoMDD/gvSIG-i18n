...
cTRAUseCasesWithAbbreviatedPermissions =  {
  'void_useCase_toImpose_View_And_ListFolderContents' : [ 
    ...
    cUseCase_Export: [    
        ...
        [
            [ [ cNombreTipoTRACadena]                    ,cPermissionsAbbreviatedFor_ViewElementAndChildren,     [ cTRACoordinator_role,cTRADeveloper_role,] +  cUbiquitousReaderRoles,],         
            [ [ cNombreTipoTRATraduccion,]               ,cPermissionsAbbreviatedFor_ViewElement + [ ],          [ cTRACoordinator_role,cTRADeveloper_role,] +  cUbiquitousReaderRoles,],
        ],                                                                                           
    ],                                                                                                  
    cUseCase_EllaborateInformeLanguages: [   
        [   {   'title':  'Si TRACatalogo',
