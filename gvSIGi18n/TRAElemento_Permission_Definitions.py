...
cTRAUseCasesWithAbbreviatedPermissions =  {
  'void_useCase_toImpose_View_And_ListFolderContents' : [ 
    ...
    cUseCase_VerifyTRACatalogo : [ 
        ...
        [
            [ cTodosNombresTiposColecciones   ,cPermissionsAbbreviatedFor_ViewElementAndChildren ,   [ cTRAManager_role,cTRACoordinator_role, cTRADeveloper_role, cTRAReviewer_role, cTRATranslator_role,] +  cUbiquitousReaderRoles,],         
        ],                                                                                           
    ],   
    ...
    cUseCase_ReuseTRAImportacion: [ 
        [   {   'title':  'Es TRAImportacion',
            ...
            {   'title':  'Already started TRAImportacion',
                'path':   [ 'object', ],
                'types':  [ cNombreTipoTRAImportacion,],     
                'pred':   [ 'getHaComenzado',],
                'roles':  [  cTRACoordinator_role,] +  cUbiquitousWriterRoles, 
    ...
    cUseCase_Export: [    
        [   {   'title':  'Si TRACatalogo',
                ...
                'path':   [ 'object',],  
                'types':  [ cNombreTipoTRACatalogo,],    
                'roles':  [ cTRACoordinator_role,cTRADeveloper_role, cTRAReviewer_role, cTRATranslator_role,] +  cUbiquitousReaderRoles, 
                'perms':  cPermissionsAbbreviatedFor_ViewElementAndChildren, 
            },
            {   'title':  'Si TRAIdioma',
            ...
            {   'title':  'Filter TRAModulo todos los accesibles',
                ...
                'mode':   cUseCaseRuleMode_Filter,
                'path':   [ 'object', 'getCatalogo', 'fObtenerTodosModulos', ],  
                'types':  [ cNombreTipoTRAModulo,cTRADeveloper_role,],    
                'pred':   [ 'fAllowRead',],
                'roles':  [ cTRACoordinator_role,cTRADeveloper_role, cTRAReviewer_role, cTRATranslator_role,] +  cUbiquitousReaderRoles, 
                'perms':  cPermissionsAbbreviatedFor_ViewElement, 
            },
        ...
        [
            [ [ cNombreTipoTRACadena]                    ,cPermissionsAbbreviatedFor_ViewElementAndChildren,     [ cTRACoordinator_role,cTRADeveloper_role, cTRAReviewer_role, cTRATranslator_role, ] +  cUbiquitousReaderRoles,],         
            [ [ cNombreTipoTRATraduccion,]               ,cPermissionsAbbreviatedFor_ViewElement + [ ],          [ cTRACoordinator_role,cTRADeveloper_role, cTRAReviewer_role, cTRATranslator_role, ] +  cUbiquitousReaderRoles,],
        ],                                                                                           
    ],       
    cUseCase_EllaborateInformeActividad: [
        [   {   'title':  'Es TRACatalogo',
    ...
    cUseCase_CreateTRAInforme: [     
        [   {   'title':  'Es TRAColeccionInformes',
                ...
                'roles':  [ cTRACoordinator_role, cTRADeveloper_role, cTRAReviewer_role,] +  cUbiquitousWriterRoles, 
            ...
            {   'title':  'Filtro TRAIdioma accesibles',
                ...
                'types':  [ cNombreTipoTRAIdioma,],    
                'pred':   [ 'fAllowRead',],
                'roles':  [ cTRACoordinator_role, cTRADeveloper_role, cTRAReviewer_role,] +  cUbiquitousReaderRoles, 
                'perms':  cPermissionsAbbreviatedFor_ViewElement, 
            },
            {   'title':  'Filtro TRAModulo accesibles',
                'name':   'modules',
        ...
        [
            [ [ cNombreTipoTRAInforme,]                  ,cPermissionsAbbreviatedFor_ViewElement + [ 'MPC', 'DOB',],           [ cTRACoordinator_role, cTRADeveloper_role, cTRAReviewer_role,] +  cUbiquitousWriterRoles,], 
        ],                                                                                           
    ],       
    cUseCase_CreateAndDeleteTRAInformeInTRAImportacion: [     
        [   {   'title':  'Es TRAImportacion',
